  ...
  return (
    ...
    <View style={styles.container}>
      <Text style={styles.text}>
        ...
        {'\n\n'}
        *En el video, al momento de filtrar la información, la imagen se congela por unos segundos debido a los componentes de dicha computadora. Se recomienda utilizar un equipo de gama media a alta, con un procesador de las ultimas generaciónes, una memoria RAM mayor a 32GB, y un SSD para un mejor rendimiento, con ello sera mas fluido en el analisis. Además, es preferible tener una ventana abierta para evitar sobrecalentamiento. CASO CONTRARIO, NO LO INTENTES en tu PC, mucho menos en tu celular, ya que esto puede hacer que tu equipo se "congele" o afectar lo que estés realizando en ese momento. Cualquier intento es bajo TU responsabilidad.{' '}
        {'\n\n'}
